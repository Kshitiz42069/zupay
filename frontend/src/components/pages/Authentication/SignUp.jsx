...
const SignUp = () => {
  ...
  return (
    <div className="relative flex items-center justify-center h-[90vh]">
      ...
      <div className="bg-[#F2F2F2] lg:w-2/3 lg:h-[35rem] flex rounded-xl lg:rounded-full">
        {/* left side */}
        <div className="w-1/2 hidden bg-[#1E201E] text-[#F2F2F2] lg:flex flex-col gap-[2rem] justify-center text-center p-4 rounded-l-xl">
          <p className="edu text-7xl">Welcome There!</p>
          <p className="nerko text-4xl">Enter your credentials to Sign Up and read some interesting blogs.</p>
        </div>
        {/* right side */}
        <div className="flex flex-col justify-center p-[2rem] lg:w-2/3 gap-[1rem]">
          ...
          <div className="flex flex-col gap-[1rem]">
            ...
            <a href="/login"><button className="btn bg-[#1E201E] text-white w-[6rem]">Login</button></a>
          </div>
        </div>
